...
import { Tab, Row, Col, Nav, Table, Image, ListGroup } from "react-bootstrap";
...
function PreFoundationPreparation() {
  return (
    <>
      <HeroHead
        title="PRE - FOUNDATION (CLASS 9 & 10)"
            ...
            <div className="col-md-8">
              <div className="card shadow-sm border-0 py-3 px-4 mt-4">
                ...
                <div className="content mt-2">
                  <p>
                    The JEE NEET Pre Foundation 9 and 10th course covers
                    critical math, physics, and chemistry topics. It has
                    practice problems, mock tests, and expert teachers. JEE NEET
                    Pre Foundation 9 and 10th course is a great way to prepare
                    for the JEE and NEET exams. It is taught by experts, covers
                    a wide range of topics, and is available online and offline
                    courses mode.
                  </p>
                </div>
              </div>
              ...
              <div className="card shadow-sm border-0 py-3 px-4 mt-3">
                <h4 className="fw-bold">SYLLABUS CLASS 9 & 10</h4>
                <div className="content mt-2">
              ...
              <div className="card shadow-sm border-0 py-3 px-4 mt-3">
                <h4 className="fw-bold">SYLLABUS CLASS 9 & 10 FEE STRUCTURE</h4>
                <div className="content mt-2">
                  <Table striped bordered responsive>
                    <thead>
                      <tr>
